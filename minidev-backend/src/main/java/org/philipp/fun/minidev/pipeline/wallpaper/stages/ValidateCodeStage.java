...
public class ValidateCodeStage extends BaseElement {
    ...
    public boolean execute(PipelineContext context) throws Exception {
        ...
        WallpaperCodeSchema response;
        try {
            response = OBJECT_MAPPER.readValue(rawJson, WallpaperCodeSchema.class);
        } catch (Exception e) {
            return false;
        }
    ...
    private boolean validateWithLlm(PipelineContext context, WallpaperCodeSchema response) {
    ...
    public record WallpaperCodeSchema(String html, String css, String js, String description) {}
}
